...
-- Task 3: Retrieve all customers from a specific city. Fetch all products under the "Fruits" category.
...
-- Task 5 Task 5: Insert 3 new rows into the Products table using INSERT statements.
...
-- Task 10 Scenario: Amazon Fresh wants to identify top customers based on their total spending. We will:
